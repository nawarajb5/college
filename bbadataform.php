...
<title>BBA| Please provide details</title>
</head>
<body>
	<div class="formdivcolor">
	<form name="bbadataform"method="post" action="bbafront.php">
		<table align="center">
			<tr>
				<th colspan="2">Fill this form First for BBA </th>
			...
			<tr>
				<td>
			Already signed up?</td><td><a href="bbalogin.php"> Click here</a></td>
