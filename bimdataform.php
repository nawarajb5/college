...
<title>BIM| Please provide details</title>
</head>
<body>
	<div class="formdivcolor">
	<form name="bimdataform"method="post" action="bimfront.php">
		<table align="center">
			<tr>
				<th colspan="2">Fill this form First for BIM </th>
			...
			<tr>
				<td>
			Already signed up?</td><td><a href="bimlogin.php"> Click here</a></td>
