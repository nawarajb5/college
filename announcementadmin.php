	...
	<body>
		<div class="container">
					...
					<div id="header_wrapper">
							...
							<ul><li><a href="uploadedblog.php">User Detail</a></li>
							<li><a href="noticeadmin.php">Upload Notice</a></li>
							<li><a href="routineadmin.php"> Update Routine</a></li>
							
							<li><a href="userdetail.php"</a>User Detail</li>
