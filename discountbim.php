			...
			<div class="container">
					...
					<div id="admission">
						...
						<tr>
							...
							<td>Desired Program: <?php echo "BIM";?></td>
							</tr>
							...
							<?php
														...
														include("connection.php");
														$select="select* from feeadmin where faculty='BIM'";
													...
													header("location:scholarshipcalculatorbim.php");
												}
