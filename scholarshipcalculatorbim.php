...
<title>BIM|Scholarship</title>
</head>
<body>
	<div class="formdivcolor">
	<form name="scholarshipcalculator"method="post" action="discountbim.php">
		<table align="center">
			<tr>
			...
			<tr>
				<td>
			go back to main menu</td><td><a href="bim.php"> Click here</a></td>
